...
function alterego_scripts() {
	wp_enqueue_style( 'alterego-fonts', get_stylesheet_directory_uri() . "/fonts.css", array(), _S_VERSION );
	...
	wp_enqueue_script( 'alterego-marquee', get_template_directory_uri() . "/js/marquee.js", _S_VERSION );
}
